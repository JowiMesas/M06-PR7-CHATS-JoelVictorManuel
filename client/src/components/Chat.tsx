...
export default function Chat() {
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 md:w-96 bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
      ...
      {/* Mensajes */}
      <div ref={containerRef} className="h-72 overflow-auto p-3 bg-gray-50">
        {msgs.map((m) => (
          <div
            key={m.id}
            className={`mb-3 flex ${
      ...
      <div className="bg-gray-50 border-t border-b border-gray-200 p-2 flex justify-end space-x-3">
        <button
